...
# python train_conv.py --gpu 0 -b 20 -e 20 --output 7 -s test5
# python train_conv.py --gpu 0 -b 20 -e 20 --output 3 -s test6
...
python test_conv.py --gpu 0 -w weight/test7.weight --output 4
