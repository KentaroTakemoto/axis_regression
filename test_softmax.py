...
for i in range(100):
    ...
    x = load_data_softmax(view_param, model_number, mode="data", angles=test_angles, size=args.image_size, xp=xp)
    y = load_data_softmax(view_param, model_number, mode="label",n_out=args.output, xp=np)
